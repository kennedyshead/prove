	...
	Lexer = chroma.MustNewLexer(
		...
		chroma.Rules{
			"root": {
				...
				{`\b(attached|creates|detached|inputs|listens|matches|outputs|reads|transforms|validates)\b`, chroma.KeywordDeclaration, nil},
				...
				{`\b(Boolean|Byte|Character|Decimal|Error|Float|Integer|List|Option|Result|Source|String|Table|Unit|Value)\b`, chroma.KeywordType, nil},
