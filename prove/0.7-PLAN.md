...
The existing `InputOutput` module (`standard`, `file`) gains `system`,
...
|---------|------|-----------|-----------|-------------------|
| `standard` | `inputs` | `standard() String` | `fgets(stdin)` | `input()` |
| `standard` | `outputs` | `standard(text String)` | `fputs(stdout)` | `print()` |
| `standard` | `validates` | `standard() Boolean` | `!feof(stdin)` | `not sys.stdin.closed` |
