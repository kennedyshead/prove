...
_register_module(
    ...
    c_map={
        ...
        ("derives", "slice"): "prove_text_slice",
        ...
        ("derives", "trim"): "prove_text_trim",
        ("derives", "lower"): "prove_text_to_lower",
        ("derives", "upper"): "prove_text_to_upper",
...
_register_module(
    ...
    c_map={
        ...
        ("derives", "add"): "prove_table_add",
        ("derives", "get"): "prove_table_get",
        ("derives", "remove"): "prove_table_remove",
        ("creates", "keys"): "prove_table_keys",
        ("derives", "values"): "prove_table_values",
...
_register_module(
    ...
    c_map={
        ...
        ("derives", "replace"): "prove_pattern_replace",
...
_register_module(
    ...
    prv_file="path.prv",
    c_map={
        ("derives", "join"): "prove_path_join",
        ("derives", "parent"): "prove_path_parent",
        ("derives", "name"): "prove_path_name",
        ("derives", "stem"): "prove_path_stem",
        ("derives", "extension"): "prove_path_extension",
        ("validates", "absolute"): "prove_path_absolute",
        ("derives", "normalize"): "prove_path_normalize",
    },
)
...
_register_module(
    ...
    prv_file="format.prv",
    c_map={
        ("derives", "pad_left"): "prove_format_pad_left",
        ("derives", "pad_right"): "prove_format_pad_right",
        ("derives", "center"): "prove_format_center",
...
_register_module(
    ...
    c_map={
        ...
        ("derives", "value"): "prove_list_ops_value",
    ...
    overloads={
        ("derives", "first", "List"): "prove_list_ops_first",
        ("derives", "first", "List<Value>"): "prove_list_ops_first",
        ("derives", "first", "List<Integer>"): "prove_list_ops_first_int",
        ("derives", "first", "List<String>"): "prove_list_ops_first_str",
        ("derives", "first", "List<Float>"): "prove_list_ops_first_float",
        ("derives", "first", "List<Decimal>"): "prove_list_ops_first_float",
        ("derives", "last", "List"): "prove_list_ops_last",
        ("derives", "last", "List<Value>"): "prove_list_ops_last",
        ("derives", "last", "List<Integer>"): "prove_list_ops_last_int",
        ("derives", "last", "List<String>"): "prove_list_ops_last_str",
        ("derives", "last", "List<Float>"): "prove_list_ops_last_float",
        ("derives", "last", "List<Decimal>"): "prove_list_ops_last_float",
        ...
        ("derives", "sort", "List<Integer>"): "prove_list_ops_sort_int",
        ...
        ("derives", "get", "Array<Boolean>"): "prove_array_get_bool",
        ("derives", "get", "Array<Integer>"): "prove_array_get_int",
        ("derives", "get", "Array<Boolean>:Mutable"): "prove_array_get_bool",
        ("derives", "get", "Array<Integer>:Mutable"): "prove_array_get_int",
        ("derives", "get", "Array<Float>"): "prove_array_get_float",
        ("derives", "get", "Array<Float>:Mutable"): "prove_array_get_float",
        ("derives", "get", "Array<Decimal>"): "prove_array_get_float",
        ("derives", "get", "Array<Decimal>:Mutable"): "prove_array_get_float",
        ("derives", "set", "Array<Boolean>"): "prove_array_set_bool",
        ("derives", "set", "Array<Integer>"): "prove_array_set_int",
        ("derives", "set", "Array<Float>"): "prove_array_set_float",
        ("derives", "set", "Array<Decimal>"): "prove_array_set_float",
        ("derives", "set", "Array<Boolean>:Mutable"): "prove_array_set_mut_bool",
        ("derives", "set", "Array<Integer>:Mutable"): "prove_array_set_mut_int",
        ("derives", "set", "Array<Float>:Mutable"): "prove_array_set_mut_float",
        ("derives", "set", "Array<Decimal>:Mutable"): "prove_array_set_mut_float",
        ...
        # Array safe access
        ("derives", "get_safe", "Array<Boolean>"): "prove_array_get_safe_bool",
        ("derives", "get_safe", "Array<Integer>"): "prove_array_get_safe_int",
        ("derives", "get_safe", "Array<Boolean>:Mutable"): "prove_array_get_safe_bool",
        ("derives", "get_safe", "Array<Integer>:Mutable"): "prove_array_get_safe_int",
        ("derives", "get_safe", "Array<Float>"): "prove_array_get_safe_float",
        ("derives", "get_safe", "Array<Float>:Mutable"): "prove_array_get_safe_float",
        ("derives", "get_safe", "Array<Decimal>"): "prove_array_get_safe_float",
        ("derives", "get_safe", "Array<Decimal>:Mutable"): "prove_array_get_safe_float",
        ...
        ("derives", "get", "List<Integer>"): "prove_list_ops_get_int",
        ("derives", "get", "List<String>"): "prove_list_ops_get_str",
        ("derives", "get", "List<Float>"): "prove_list_ops_get_float",
        ("derives", "get", "List<Decimal>"): "prove_list_ops_get_float",
        ("derives", "get", "List<Value>"): "prove_list_ops_get_value",
        # List get_safe (bounds-checked access)
        ("derives", "get_safe", "List<Integer>"): "prove_list_ops_get_safe_int",
        ("derives", "get_safe", "List<String>"): "prove_list_ops_get_safe_str",
        ("derives", "get_safe", "List<Float>"): "prove_list_ops_get_safe_float",
        ("derives", "get_safe", "List<Decimal>"): "prove_list_ops_get_safe_float",
        ("derives", "get_safe", "List<Value>"): "prove_list_ops_get_safe_value",
        # Array first / last
        ("derives", "first", "Array<Integer>"): "prove_array_first_int",
        ("derives", "first", "Array<Integer>:Mutable"): "prove_array_first_int",
        ("derives", "first", "Array<Boolean>"): "prove_array_first_bool",
        ("derives", "first", "Array<Boolean>:Mutable"): "prove_array_first_bool",
        ("derives", "first", "Array<Decimal>"): "prove_array_first_float",
        ("derives", "first", "Array<Decimal>:Mutable"): "prove_array_first_float",
        ("derives", "first", "Array<Float>"): "prove_array_first_float",
        ("derives", "first", "Array<Float>:Mutable"): "prove_array_first_float",
        ("derives", "last", "Array<Integer>"): "prove_array_last_int",
        ("derives", "last", "Array<Integer>:Mutable"): "prove_array_last_int",
        ("derives", "last", "Array<Boolean>"): "prove_array_last_bool",
        ("derives", "last", "Array<Boolean>:Mutable"): "prove_array_last_bool",
        ("derives", "last", "Array<Decimal>"): "prove_array_last_float",
        ("derives", "last", "Array<Decimal>:Mutable"): "prove_array_last_float",
        ("derives", "last", "Array<Float>"): "prove_array_last_float",
        ("derives", "last", "Array<Float>:Mutable"): "prove_array_last_float",
        # Array empty
        ...
        # Array slice
        ("derives", "slice", "Array<Integer>"): "prove_array_slice_int",
        ("derives", "slice", "Array<Integer>:Mutable"): "prove_array_slice_int",
        ("derives", "slice", "Array<Boolean>"): "prove_array_slice_bool",
        ("derives", "slice", "Array<Boolean>:Mutable"): "prove_array_slice_bool",
        ("derives", "slice", "Array<Decimal>"): "prove_array_slice_float",
        ("derives", "slice", "Array<Decimal>:Mutable"): "prove_array_slice_float",
        ("derives", "slice", "Array<Float>"): "prove_array_slice_float",
        ("derives", "slice", "Array<Float>:Mutable"): "prove_array_slice_float",
        # Array reverse
        ("derives", "reverse", "Array<Integer>"): "prove_array_reverse_int",
        ("derives", "reverse", "Array<Integer>:Mutable"): "prove_array_reverse_int",
        ("derives", "reverse", "Array<Boolean>"): "prove_array_reverse_bool",
        ("derives", "reverse", "Array<Boolean>:Mutable"): "prove_array_reverse_bool",
        ("derives", "reverse", "Array<Decimal>"): "prove_array_reverse_float",
        ...
        ("derives", "sort", "Array<Decimal>"): "prove_array_sort_float",
        ("derives", "sort", "Array<Decimal>:Mutable"): "prove_array_sort_float",
        ("derives", "sort", "Array<Float>"): "prove_array_sort_float",
        ("derives", "sort", "Array<Float>:Mutable"): "prove_array_sort_float",
    },
    aliases=["list", "array"],
)
...
_register_module(
    ...
    overloads={
        ...
        ("derives", "unwrap", "Option<Integer>"): "prove_error_unwrap_or_int",
        ("derives", "unwrap", "Option<String>"): "prove_error_unwrap_or_str",
        ("derives", "unwrap", "Option<Float>"): "prove_error_unwrap_or_float",
        ("derives", "unwrap", "Option<Decimal>"): "prove_error_unwrap_or_float",
        ("derives", "unwrap", "Option<Boolean>"): "prove_error_unwrap_or_bool",
        ("derives", "unwrap", "Option<Node>"): "prove_error_unwrap_or_ptr",
        ("derives", "unwrap", "Option<Value>"): "prove_error_unwrap_or",
    },
)
...
_register_module(
    ...
    link_flags=["-lm"],
    c_map={
        ("derives", "sqrt"): "prove_math_sqrt",
        ("derives", "pow"): "prove_math_pow",
        ("derives", "power"): "prove_math_pow",
        ("creates", "floor"): "prove_math_floor",
        ("creates", "ceil"): "prove_math_ceil",
        ("creates", "round"): "prove_math_round",
        ("derives", "log"): "prove_math_log",
        ("derives", "log10"): "prove_math_log10",
        ("derives", "sin"): "prove_math_sin",
        ("derives", "cos"): "prove_math_cos",
        ("derives", "tan"): "prove_math_tan",
        ("derives", "asin"): "prove_math_asin",
        ("derives", "acos"): "prove_math_acos",
        ("derives", "atan"): "prove_math_atan",
        ("derives", "atan2"): "prove_math_atan2",
        ("derives", "exp"): "prove_math_exp",
        ("derives", "log2"): "prove_math_log2",
        ("derives", "pi"): "prove_math_pi",
        ("derives", "e"): "prove_math_e",
    },
    overloads={
        ("derives", "abs", "Integer"): "prove_math_abs_int",
        ("derives", "abs", "Float"): "prove_math_abs_float",
        ("derives", "abs", "Decimal"): "prove_math_abs_float",
        ("derives", "min", "Integer"): "prove_math_min_int",
        ("derives", "min", "Float"): "prove_math_min_float",
        ("derives", "min", "Decimal"): "prove_math_min_float",
        ("derives", "max", "Integer"): "prove_math_max_int",
        ("derives", "max", "Float"): "prove_math_max_float",
        ("derives", "max", "Decimal"): "prove_math_max_float",
        ("derives", "clamp", "Integer"): "prove_math_clamp_int",
        ("derives", "clamp", "Float"): "prove_math_clamp_float",
        ("derives", "clamp", "Decimal"): "prove_math_clamp_float",
    },
)
...
_register_module(
    ...
    c_map={
        ...
        ("derives", "days"): "prove_time_reads_days",
        ("validates", "days"): "prove_time_validates_days",
    },
    overloads={
        ("validates", "time", "Time"): "prove_time_validates",
        ("derives", "duration", "Duration"): "prove_time_reads_duration",
        ...
        ("derives", "date", "Date"): "prove_time_transforms_date",
...
_register_module(
    ...
    c_map={
        ...
        ("derives", "patch"): "prove_store_patch",
...
_register_module(
    ...
    c_map={
        ...
        ("derives", "stem"): "prove_language_stem",
        ("derives", "root"): "prove_language_root",
        ("creates", "distance"): "prove_language_distance",
        ("creates", "similarity"): "prove_language_similarity",
        ("derives", "soundex"): "prove_language_soundex",
        ("derives", "metaphone"): "prove_language_metaphone",
        ("creates", "ngrams"): "prove_language_ngrams",
        ("creates", "bigrams"): "prove_language_bigrams",
        ("derives", "normalize"): "prove_language_normalize",
        ("derives", "transliterate"): "prove_language_transliterate",
        ("derives", "stopwords"): "prove_language_stopwords",
...
_register_module(
    ...
    c_map={
        ...
        ("derives", "size"): "prove_terminal_size",
        ("derives", "ansi"): "prove_terminal_color_ansi",
    },
    overloads={
