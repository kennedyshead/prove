...
_register_module(
    ...
    overloads={
        ...
        ("reads", "index", "List<Float>"): "prove_list_ops_index_float",
        ("reads", "index", "List<Decimal>"): "prove_list_ops_index_float",
        ...
        ("reads", "index", "Array<Boolean>"): "prove_array_index_bool",
        ("reads", "index", "Array<Boolean>:Mutable"): "prove_array_index_bool",
        ("reads", "index", "Array<Float>"): "prove_array_index_float",
        ("reads", "index", "Array<Float>:Mutable"): "prove_array_index_float",
        ("reads", "index", "Array<Decimal>"): "prove_array_index_float",
        ("reads", "index", "Array<Decimal>:Mutable"): "prove_array_index_float",
        # Array slice
...
_register_module(
    ...
    overloads={
        ...
        ("reads", "string", "Byte"): "prove_convert_string_byte",
        ...
        ("reads", "string", "ByteArray"): "prove_bytes_to_string",
...
_register_module(
    ...
    overloads={
        ...
        ("transforms", "clamp", "Decimal"): "prove_math_clamp_float",
    },
)
