...
|----------|-----------|-----------|
| `toml` | `creates toml(source String) Result<Value, String>` | TOML parser, maps to target type |
| `toml` | `reads toml(value Value) String` | Struct to TOML text |
| `json` | `creates json(source String) Result<Value, String>` | JSON parser, maps to target type |
| `json` | `reads json(value Value) String` | Struct to JSON text |
